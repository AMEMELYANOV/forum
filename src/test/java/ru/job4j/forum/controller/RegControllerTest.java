 ...
 * @version 1.0
 * @see ru.job4j.forum.controller.RegController
 */
...
public class RegControllerTest {
    ...
    /**
     * Выполняется проверка редиректа на страницу входа пользователя
     * и вызов метода сервисного слоя {@link ImplUserService#save(User)}
